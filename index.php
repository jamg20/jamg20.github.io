...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true){
    // Si el usuario ya ha iniciado sesión, redirigir a la página home.php
    header("Location: home.php");
    exit;
}
// Verificar si se enviaron datos de inicio de sesión
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Procesar los datos del formulario y verificar las credenciales del usuario
    // Resto del código para verificar las credenciales y manejar la autenticación
}
?>
<!DOCTYPE html>
<html lang="es-MX">
